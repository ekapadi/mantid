...
//
// NOTE: This file is intentionally RENAMED from SNSLiveEventDataListenerTest.h
// to SNSLiveEventDataListenerLegacyTest.h.  It is retained for reference but is
// NOT registered in TEST_FILES and will NOT be compiled or run by ctest.
// New integration tests live in SNSLiveEventDataListenerTest.h (MockSMSServer
// suite).  See plans/v3_integration_test/SNSListener-integration-test.md §2.
#pragma once
