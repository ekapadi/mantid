...
void SNSLiveEventDataListener::onBeforeExtract() {
  ...
  // iterations).  An immediate load avoids a 500 ms wait and structurally
  // closes the inter-rxPacket race: the flag is only restored to true after
  // all rxPacket() calls for the current parse iteration have completed.
